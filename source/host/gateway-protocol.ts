...
export const SAND_GATEWAY_COMMANDS = {
  ...
  addAgentMemory: (api: GatewayApi, body: string) => api.addAgentMemory(parseCommandArgs(body)),
  deleteAgentMemory: (api: GatewayApi, body: string) => api.deleteAgentMemory(parseCommandArgs(body)),
  getAgentModelSelection: (api: GatewayApi, body: string) => api.getAgentModelSelection(parseCommandArgs(body)),
  setAgentModelSelection: (api: GatewayApi, body: string) => api.setAgentModelSelection(parseCommandArgs(body)),
