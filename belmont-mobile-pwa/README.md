...
An isolated, dependency-free mobile vertical slice for the Linear project. Belmont remains the single user-facing chief-of-staff bot inside the PWA.
...
- Linear project mark wired as the favicon, Apple touch icon, profile mark and 192px/512px PWA install assets
- Self-hosted PP Neue Montreal for Latin text and Pretendard Variable for Korean text
...
- Node contract suite: 28/28 passed (includes the pairing-backoff and Linear branding regressions).
...
- Chromium at 430×932: the Linear roster and Belmont chat/approval rendered from the final source in light and dark mode with zero page/console errors. The browser loaded PP Neue Montreal, Pretendard Variable, and the Linear project mark from the packaged PWA assets.
...
Current identity evidence: [`artifacts/40-linear-brand-live-home.png`](./artifacts/40-linear-brand-live-home.png), [`artifacts/41-linear-brand-live-chat.png`](./artifacts/41-linear-brand-live-chat.png), and [`artifacts/42-linear-brand-live-dark.png`](./artifacts/42-linear-brand-live-dark.png). Scanner, confirmation, and message-run evidence remains in [`artifacts/20-openmaus-scanner-final.png`](./artifacts/20-openmaus-scanner-final.png), [`artifacts/22-openmaus-qr-confirmation-final.png`](./artifacts/22-openmaus-qr-confirmation-final.png), and [`artifacts/26-openmaus-message-run-final.png`](./artifacts/26-openmaus-message-run-final.png).
